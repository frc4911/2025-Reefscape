...
public class TunerConstants {
      ...
      new Pigeon2Configuration()
          .withMountPose(
              new MountPoseConfigs()
                  .withMountPoseYaw(Degrees.of(0))
                  .withMountPosePitch(Degrees.of(0))
                  .withMountPoseRoll(Degrees.of(0)));
  ...
  private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.247802734375); // hi
  ...
  private static final Angle kFrontRightEncoderOffset = Rotations.of(-0.43212890625);
