...
public final class AutoAlign extends Command {
  ...
  /**
   * A representation of poses that the robot should be in to score on corresponding reef branches.
   * The naming begins with the branch on the left side of the reef face facing the driver station
   * wall and increases counterclockwise around the reef. Refer to the game manual for a visual aid.
   */
